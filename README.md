...
unsigned long myChannelNumber =  2929157;
const int ChannelField = 1;
const char * myWriteAPIKey = "SSXTN7UXFX53ZI6C";
...
# CIRCUIT DIAGRAM:
![circuit diagram](https://github.com/user-attachments/assets/fe85e737-422c-4909-b2ec-d6a33a486015)

# OUTPUT:
![Screenshot](https://github.com/user-attachments/assets/d2ac1bf8-8f78-40db-b540-9f9d7fa2fa79)

![image2](https://github.com/user-attachments/assets/11adefdb-8e1e-4a9a-ad71-78eb4d7a3311)
